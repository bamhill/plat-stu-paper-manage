...
const STYLES: Record<string, string> = {
  ...
  closed_history: "bg-slate-100 text-slate-500",
  ...
  with_editor: "bg-indigo-100 text-indigo-800",
  under_review: "bg-cyan-100 text-cyan-800",
  awaiting_reviewer_assignment: "bg-amber-100 text-amber-800",
...
const LABELS: Record<string, string> = {
  ...
  with_editor: "编辑处理中", under_review: "外审中", awaiting_reviewer_assignment: "等待分配审稿人",
  minor_revision: "小修", major_revision: "大修", accepted: "已接收",
  rejected: "已拒稿", published: "已发表",
  pending: "待处理", closed_history: "历史已结束", decisioned: "已返回",
