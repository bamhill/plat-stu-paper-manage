...
export const studentSchema = z.object({
  ...
  showOnDashboard: z.boolean().nullable().optional(),
...
export const thesisSchema = z.object({
  ...
  expert1Score: z.string().nullable().optional(),
  expert2Score: z.string().nullable().optional(),
  expert3Score: z.string().nullable().optional(),
